...
class Util
{
    ...
    public static function checkRange($name, Range $range, $value, $unit = '')
    {
        ...
        if (! \is_numeric($val)) {
            throw new RangeException(esc_html("$name {$val} is not a number."));
        }
        ...
        throw new RangeException(esc_html("$name {$val} must be between {$range->first} and {$range->last}$unit"));
    }
    ...
    public static function mbStrlen($string)
    {
        ...
        throw new \LogicException(esc_html('Either mbstring (recommended) or iconv is necessary to use Scssphp.'));
    }
