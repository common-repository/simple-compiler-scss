...
final class Warn
{
    ...
    /**
     * Prints a warning message associated with the current `@use` or function call.
     *
    ...
    /**
     * Prints a deprecation warning message associated with the current `@use` or function call.
     *
     * This may only be called within a custom function or importer callback.
     *
     * @param string $message
