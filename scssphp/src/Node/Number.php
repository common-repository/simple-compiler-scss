...
class Number extends Node implements \ArrayAccess, \JsonSerializable
{
    ...
    public function valueInRange($min, $max, $name = null)
    {
        try {
            ...
            throw SassScriptException::forArgument(esc_html(sprintf('Expected %s to be within %s%s and %s%3$s.', $this, $min, $this->unitStr(), $max)), esc_html($name));
        }
    }
    ...
    public function valueInRangeWithUnit($min, $max, $name, $unit)
    {
        try {
            ...
            throw SassScriptException::forArgument(esc_html(sprintf('Expected %s to be within %s%s and %s%3$s.', $this, $min, $unit, $max)), esc_html($name));
        }
    }
    ...
    public function assertNoUnits($varName = null)
    {
        ...
        throw SassScriptException::forArgument(esc_html(sprintf('Expected %s to have no units.', $this)), esc_html($varName));
    }
    ...
    public function assertUnit($unit, $varName = null)
    {
        ...
        throw SassScriptException::forArgument(esc_html(sprintf('Expected %s to have unit "%s".', $this, $unit)), esc_html($varName));
    }
    ...
    public function assertSameUnitOrUnitless(Number $other)
    {
        ...
        throw new SassScriptException(esc_html(sprintf(
