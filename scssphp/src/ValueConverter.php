...
final class ValueConverter
{
    ...
    public static function parseValue($source)
    {
        ...
        if (!$parser->parseValue($source, $value)) {
            throw new \InvalidArgumentException(esc_html(sprintf('Invalid value source "%s".', $source)));
        }
    ...
    public static function fromPhp($value)
    {
        ...
        throw new \InvalidArgumentException(esc_html(sprintf('Cannot convert the value of type "%s" to a Sass value.', gettype($value))));
    }
}
